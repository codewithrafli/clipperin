...
from clipper_core import Config, WhisperModel, AIProviderType, OutputConfig
from clipper_cli.config.settings import get_config_path, load_user_config, save_user_config
...
def config_command(
    ...
    Examples:
        clipper config                           # Show all config
        clipper config --list                    # List all config
        clipper config ai.provider groq          # Set AI provider
        clipper config ai.groq_api_key sk-xxxx   # Set API key
        clipper config whisper.model base        # Set Whisper model
    """
